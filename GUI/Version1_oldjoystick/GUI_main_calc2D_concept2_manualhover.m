...
if ~pauseflag && ~simulateflag
    ...
    d_phiwingmax = 25 * pi/180; %for the tiltwing: maximal deflection from phiwing0
    ...
    rb2D_acw = [0.10; 0.15]; %wing aero. center with respect to mass center
    ...
    for n = 2:Ncalc
        ...
        phiwingset = phiwing0 + d_phiwingmax * -axis(joy,4);
