%this is a D model to analyze the transition mode of UAV, hover mode
...
%     Tback2hover = 30;
    ...
    rb2D_acs = [-1.5; 0]; %elevator aero. center with respect to mass center
