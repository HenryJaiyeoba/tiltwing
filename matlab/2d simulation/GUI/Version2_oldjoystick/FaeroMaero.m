function [Fb, M, Cl, Cd] = FaeroMaero(Vb_air, Rb_ac, rho, S, chord, Cm, Clmin, Clmax, Cdmin, Cdmax, alpmax)
%this function calculates aerodynamic force (2D vector) and torque (scalar,
%anticlock.) of a wing/stabilitor/fuselage in "local" (airfoil-attached)
...
%Rb_ac - location of aerodynamic center with respect to mass center
...
M = Rb_ac(1)*Fb(2) - Rb_ac(2)*Fb(1) + Maero;